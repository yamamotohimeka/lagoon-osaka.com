    ...
    <div class="container">
      <div class="about__desc">
        ...
        <div class="about__desc-point">
          ...
          <div class="about__desc-point-box">
            <div class="about__desc-point-box-title">◆出稼ぎ保証◆7万円～</div>
            <p>
              自由シフト制になりますので旅行で遊びに来られている際もスキマ時間を利用して稼げます！！<br>
              最低7万円の日給保証を設けており短期間の滞在でもまとまったお給料をお持ち帰り頂くことが<br>
              可能です。また、お好きな期間で働けますので短期、長期でお考えの方は面接時にご相談ください。
            </p>
          </div>
        </div>
      </div>
