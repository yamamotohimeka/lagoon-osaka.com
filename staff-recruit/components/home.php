  ...
  <div class="container">
    ...
    <ul class="home__salary">
      <li class="home__salary--list">
        ...
        <p class="t-gold">
          <span class="t-bigger">70</span><span class="t-normal">万円+インセンティブ</span>
        </p>
      </li>
      <li class="home__salary--list">
        <p class="t-white">
        ...
        <p class="t-gold">
          <span class="t-bigger">55</span><span class="t-normal">万円+インセンティブ</span>
        </p>
      </li>
    </ul>
    <ul class="home__feature">
      ...
      <li class="home__feature--list">
        <span class="featureText">社員寮案内可能</span>
      </li>
      <li class="home__feature--list">
        <span class="featureText">日払い対応可能</span>
      </li>
      <li class="home__feature--list">
        <span class="featureText">アルバイトOK</span>
      </li>
      <li class="home__feature--list">
        <span class="featureText">通し勤務なし</span>
      </li>
      <li class="home__feature--list">
        <span class="featureText">有給休暇あり</span>
      </li>
    </ul>
    <div class="home__msg">
