<section class="interview" id="interview">
  <div class="container interviewContainer">
    ...
    <div class="interviewResponsive">
      <div>
        <div class="interview__staff">
          ...
          <p class="interview__staff--info lastContent">前職：営業</p>
        </div>
        <p class="interview__text01">もっと稼げる仕事を<br class="tab">求めて入社半年。</p>
      </div>
      <div class="interviewBg tab">
